// Vercel Serverless Function - American Football (NFL) Games
// Proxies requests to API-American-Football for games/fixtures
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const url = `${API_NFL_URL}/games?${params.toString()}`;
    ...
    return res.status(500).json({ error: 'Failed to fetch NFL games' });
  }
}
