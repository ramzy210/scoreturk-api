// Vercel Serverless Function - Rugby Games
// Proxies requests to API-Rugby for games/fixtures
...
export default async function handler(req, res) {
  ...
  try {
    ...
    const url = `${API_RUGBY_URL}/games?${params.toString()}`;
    ...
    return res.status(500).json({ error: 'Failed to fetch rugby games' });
  }
}
